...
def test_snd_layer(load=False, save=True, verbose=1):
    model = model_snd()
    if load:
...
def test_routine2():
    ...
    :return:
    """
    print("Test routine #2, original model first, second layer next")
    sys.stdout = Logger(LOG_PATH + '/cifar100_routine2.log')
    print("test original simple CNN")
    test_original(2)
    print("test snd layer")
    test_snd_layer(load=False, verbose=2)


def test_routine3():
    sys.stdout = Logger(LOG_PATH + '/cifar100_routine3.log')
    test_snd_layer(load=False, save=False, verbose=2)


def test_routine4():
    print('resnet test')
    sys.stdout = Logger(LOG_PATH + '/cifar100_resnet50.log')
    test_resnet50_original(verbose=2)
