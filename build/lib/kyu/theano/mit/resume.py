...
from kyu.theano.minc.finetune import mit_indoor_finetune
...
from kyu.theano.minc.configs import get_experiment_settings, get_aaai_experiment, get_log_experiment, get_von_settings, \
    get_von_with_regroup, get_von_with_multibranch, get_matrix_bp, get_VGG_dimension_reduction, get_matrix_bp_vgg, \
    get_cov_beta_cv
...
RESNET_BASELINE_WEIGHTS_PATH = '/home/kyu/.keras/models/mit_indoor_finetune_resnet-baseline_resnet_1.weights'
VGG_BASELINE_WEIGHTS_PATH = '/home/kyu/.keras/models/baseline/mit_indoor_finetune_vgg16-baseline_vgg16_1.weights'

def resume_model_with_config(model, config, title='mit_indoor',
    ...
    if stiefel_observed is None:
        resume_finetune(model, mit_indoor_finetune,
        ...
        resume_finetune_with_Stiefel_layer(model, mit_indoor_finetune,
                                           weights_path=weights_path,
                                           nb_classes=nb_classes,
                                           input_shape=input_shape, config=config,
                                           nb_epoch_finetune=nb_epoch_finetune, nb_epoch_after=nb_epoch_after,
...
if __name__ == '__main__':
    # weights_path = 'finetune_mit_indoor_resnet_MB-stiefelminc_von_mean_o2t_no_wv_robost_None_cov_o2t_no_wv_wv64_pmean' \
    #                '-ResNet_o2-multi-o2t_no_wv_para-257_128_64_mode_3nb_branch_2_1.weights'
    # weights_path = 'retrain_mit_indoor_resnet50_stiefelaaai_baseline_cov_aaai_wv128_mean-' \
    ...
    # weights_path = '/home/kyu/.keras/models/finetune_mit_indoor_DR_pmean_robost_LC[]_cov_o2transform_wv64_pmean-' \
    #                'VGG16_o2_para-257_128_64_mode_1nb_branch_2_1.weights'
    # weights_path = VGG_BASELINE_WEIGHTS_PATH
    weights_path = '/home/kyu/.keras/models/dtd_finetune_vgg16_bilinear-baseline_vgg16_bilinear_1.weights_50'
    ...
    #                       nb_epoch_after=100)
    # resume_routine_vgg(config=config, verbose=(1,2), weights_path=weights_path, by_name=True, nb_epoch_finetune=0,
                       # stiefel_observed=['o2t'],
                       # stiefel_lr=(0.001, 0.0001),
                       # nb_epoch_after=20)
    resume_baseline_
