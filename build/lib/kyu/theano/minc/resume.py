...
from kyu.theano.minc.finetune import minc2500_finetune
...
RESNET_BASELINE_WEIGHTS_PATH = '/home/kyu/.keras/models/minc2500_finetune_resnet-baseline_resnet_1.weights'
VGG_BASELINE_WEIGHTS_PATH = '/home/kyu/.keras/models/baseline/minc2500_finetune_vgg16-baseline_vgg16_1.weights'

def resume_model_with_config(model, config, title='minc2500',
    ...
    if stiefel_observed is None:
        resume_finetune(model, minc2500_finetune,
        ...
        resume_finetune_with_Stiefel_layer(model, minc2500_finetune,
                                           weights_path=weights_path,
                                           nb_classes=nb_classes,
                                           input_shape=input_shape, config=config,
                                           nb_epoch_finetune=nb_epoch_finetune, nb_epoch_after=nb_epoch_after,
...
if __name__ == '__main__':
    ...
    weights_path = '/tmp/VGG16_o2_para-257_128_64_mode_1_672_finetune.weights'
